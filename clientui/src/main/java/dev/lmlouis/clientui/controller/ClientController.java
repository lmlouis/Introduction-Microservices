...
import dev.lmlouis.clientui.beans.CommandeBean;
import dev.lmlouis.clientui.beans.PaiementBean;
import dev.lmlouis.clientui.beans.ProductBean;
import dev.lmlouis.clientui.proxy.MicroserviceCommandeProxy;
import dev.lmlouis.clientui.proxy.MicroservicePaiementProxy;
import dev.lmlouis.clientui.proxy.MicroserviceProduitsProxy;
...
public class ClientController {
    ...
    * */
    ...
    public String requestMethodName(Model model) {
        List<ProductBean> produits =  produitsProxy.listeDesProduit();
